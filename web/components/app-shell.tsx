...
const sessions = [
  ["Filler O2 pressure instability", "10:42 AM"],
  ["Conveyor 11 alignment check", "9:37 AM"],
  ["Line 3 lockout review", "8:58 AM"],
  ["Capper 04 torque variation", "8:12 AM"],
];
    ...
    <aside className="app-sidebar" aria-label="Workspace navigation">
      ...
      <section className="chat-nav" aria-label="Chat sessions">
        ...
        {sessions.map(([title, time]) => (
          <Link className="session-item" href="/chat" key={title}>
        ...
        {[
          ["Palletizer 02 cycle", "Yesterday"],
          ["Boiler feed pump", "Yesterday"],
        ].map(([title, time]) => (
          <Link className="session-item" href="/chat" key={title}>
            <MessageCircle size={16} />
            <span>{title}</span>
        ...
        <Link className="session-item" href="/chat">
          <MessageCircle size={16} />
          <span>Vision system lighting</span>
          <time>Tue</time>
        </Link>
      </section>
